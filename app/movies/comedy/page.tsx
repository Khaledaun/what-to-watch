...
export const metadata: Metadata = {
  title: 'Comedy Movies - Laugh-Out-Loud Entertainment - What to Watch Tonight',
  ...
  alternates: {
    canonical: 'https://whattowatch.com/movies/comedy',
  },
};

export default async function ComedyMoviesPage() {
  // Fetch comedy movies (for now, we'll use recent movies as a proxy)
  ...
  const collectionLD = generateCollectionLD({
    ...
    url: 'https://whattowatch.com/movies/comedy',
  });

  const breadcrumbLD = generateBreadcrumbLD([
    { name: 'Home', url: '/' },
    { name: 'Movies', url: '/movies' },
    { name: 'Comedy', url: '/movies/comedy' },
  ]);
      ...
      <main className="container mx-auto px-4 py-8">
        <header className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Discover the funniest comedy movies guaranteed to make you laugh. From classic comedies to modern hits.
          </p>
        </header>
