...
export const metadata: Metadata = {
  title: 'Action Movies - High-Octane Thrills - What to Watch Tonight',
  description: 'Discover the best action movies with high-octane thrills, explosive sequences, and adrenaline-pumping entertainment.',
  openGraph: {
    title: 'Action Movies - High-Octane Thrills - What to Watch Tonight',
    description: 'Discover the best action movies with high-octane thrills, explosive sequences, and adrenaline-pumping entertainment.',
    type: 'website',
  ...
  alternates: {
    canonical: 'https://whattowatch.com/movies/action',
  },
};

export default async function ActionMoviesPage() {
  // Fetch action movies (for now, we'll use high-rated movies as a proxy)
  ...
  const collectionLD = generateCollectionLD({
    name: 'Action Movies - High-Octane Thrills',
    description: 'Discover the best action movies with high-octane thrills, explosive sequences, and adrenaline-pumping entertainment.',
    ...
    url: 'https://whattowatch.com/movies/action',
  });
      ...
      <main className="container mx-auto px-4 py-8">
        <header className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Discover the best action movies with high-octane thrills, explosive sequences, and adrenaline-pumping entertainment.
          </p>
        </header>
